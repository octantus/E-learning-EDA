...
# Выводы
Использовала Python для выгрузки и изучения данных, трактовала данные, исследовала их на наличие аномалий, аргументировала причины решений, провела анализ аудитории с помощью адаптированной кластеризации c последующей визуализацией.
